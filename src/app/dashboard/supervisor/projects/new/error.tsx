...
type SupervisorNewProjectErrorProps = {
  error: Error;
  reset: () => void;
};

export default function SupervisorNewProjectError({
  error,
  reset,
}: SupervisorNewProjectErrorProps) {
  return (
    <main className="mx-auto max-w-4xl px-6 py-12">
      <div className="rounded-3xl border border-rose-200 bg-white p-8 shadow-sm">
        ...
        <h1 className="mt-4 text-3xl font-bold tracking-tight text-slate-950">
          Impossible d&apos;ouvrir le formulaire projet
        </h1>
